...
//        // =========== IO EXERCISE =========== //
          // Example for our curriculum //

//        Scanner scanner = new Scanner(System.in); // First we declare a variable
//                                                  // of type Scanner, and assign
//                                                  // to it a new Scanner object.
//
//        System.out.print("Enter something: ");    // Next, prompt the user for input.
//
//        String userInput = scanner.next();        // obtain the value the user entered
//                                                  // as a String, and store it
...
//        // The Scanner Class
//
            // Prompt a user to enter a integer and store
